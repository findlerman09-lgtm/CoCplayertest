# Miriam Hart dossier routes

- `/characters/miriam-hart/` — Overview
- `/characters/miriam-hart/sheet/` — Character Sheet
- `/characters/miriam-hart/people/` — People
- `/characters/miriam-hart/correspondence/` — Correspondence
