---
layout: character
permalink: /characters/arthur-bell/
title: Arthur Bell
name: Arthur Bell
occupation: Fire-insurance Surveyor of Risks
age: 43
residence: Clerkenwell
social_status: Self-made respectable commercial professional
top_nav: investigators
character_slug: arthur-bell
context_nav: overview
display_title: Arthur Bell
...
human_detail: >-
  Bell's manner is quiet, dry, and observant. He is more likely to test a practical assumption than to make a dramatic declaration.
player_edges:
  - label: Competence spotlight
    title: Loads & Movement
    text: >-
      You are particularly good at noticing small physical discrepancies and reasoning about weight, packing, storage, carts, horses, access, and what moving people or goods through a space would actually require.
  - label: Unique access
